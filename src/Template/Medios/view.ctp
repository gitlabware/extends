...
<div class="medios view large-10 medium-9 columns">
    <h2><?= h($medio->id) ?></h2>
    <div class="row">
        ...
        <div class="large-2 columns numbers end">
            ...
            <p><?= $this->Number->format($medio->id) ?></p>
        </div>
        <div class="large-2 columns dates end">
            <h6 class="subheader"><?= __('Created') ?></h6>
            <p><?= h($medio->created) ?></p>
            <h6 class="subheader"><?= __('Modified') ?></h6>
            <p><?= h($medio->modified) ?></p>
        </div>
    </div>
    <div class="row texts">
        <div class="columns large-9">
            <h6 class="subheader"><?= __('Descripcion') ?></h6>
            <?= $this->Text->autoParagraph(h($medio->descripcion)) ?>
        </div>
    </div>
</div>
<div class="related row">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <?php foreach ($medio->noticias as $noticias): ?>
        <tr>
            <td><?= h($noticias->id) ?></td>
